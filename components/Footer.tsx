...
export default function Footer() {
  ...
  return (
    <div className='flex px-28 py-8 gap-16 bg-[#F7F9FB] w-full'>
        <div className='flex flex-col justify-center gap-3'>
                    <Image src={'/logo.jpg'} alt="Logo" width={50} height={50}></Image>
                    <h1 className='font-medium text-[16px]'>Sinked<span className='text-[#0275B1]'>In</span></h1>
        </div>
        <div className='flex flex-col gap-4 w-2/3'>
            <div>
                <h2 className='font-medium text-[14px]'>Navigation</h2>
            </div>
            <div className='grid grid-cols-3 gap-4'>
                {list.map((opt,i)=>(
                    <p key={i} className='w-max cursor-pointer hover:underline text-[13px] '>{opt}</p>
                ))}
            </div>
        </div>
        <div className='flex flex-col gap-2'>
            <div>
                <h2 className='font-medium text-[14px]'>Fast access</h2>
            </div>
            <div className='flex flex-col gap-2'>
        ...
        <div className='flex flex-col gap-4'>
            <div>
                <h2 className='font-medium text-[14px]'>Language</h2>
            </div>
